...
(define-library (disk)
 ...
 (import (a-d disk disk)
         ...
         ;(03-Sequentiele-files-en-cached-disks Oplossingen cached-disk-info) ; zie WPO
         ;(03-Sequentiele-files-en-cached-disks Oplossingen cached-disk-wbwa-info) ; zie WPO
         )
 )